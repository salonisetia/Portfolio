      ...
      <section id="experience" className="py-20 px-10 md:px-20 bg-black border-t border-gray-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 relative">
            <h2 className="text-6xl md:text-8xl font-black text-white/[0.03] absolute left-0 right-0 top-1/2 -translate-y-1/2 pointer-events-none uppercase tracking-widest">EXPERIENCE</h2>
            <h3 className="text-4xl font-black relative z-10">Work Experience</h3>
          </div>
          <div className="bg-[#111111] p-8 md:p-10 rounded-xl border border-gray-900 hover:border-yellow-500 text-left group transition-all duration-300">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
              <div>
                <span className="text-yellow-500 font-black text-xl mb-2 block">June – August 2026</span>
                <h4 className="text-2xl font-bold group-hover:text-yellow-500 transition-colors">Software Engineering Intern</h4>
                <p className="text-gray-400 text-xs font-black uppercase tracking-widest mt-1">
                  Maruti Suzuki India Limited <span className="text-gray-600">| Gurugram, India</span>
                </p>
              </div>
            </div>
            <ul className="list-disc list-inside space-y-3 text-gray-400 leading-relaxed text-sm md:text-base border-t border-gray-900 pt-6 mt-6">
              <li>Engineered a dynamic KPI Dashboard to continuously monitor real-time system performance and log error-related tokens.</li>
              <li>Developed tracking workflows to detect, categorize, and streamline the resolution of error-related authentication tokens.</li>
            </ul>
          </div>
        </div>
      </section>
